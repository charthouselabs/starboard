...
/**
 * Test sending a message that simulates a server response
 * @param websocket - The IndexerWebsocket instance
 */
export function testServerSimulation(websocket: IndexerWebsocket): void {
  websocket.testServerSimulation();
}

/**
 * Helper function to send a custom message to the websocket
 * @param websocket - The IndexerWebsocket instance
